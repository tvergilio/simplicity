...
<head>
    ...
    <app:isAuthenticated>
        <p class="navbar-text navbar-right">Signed in as <a href="#" class="navbar-link">${session.user.name}</a></p>
    </app:isAuthenticated>
    <app:isNotAuthenticated>
        <g:link class="navbar-text navbar-right" controller="auth" action="showLogin" id="1">Login</g:link>
    </app:isNotAuthenticated>
</head>
